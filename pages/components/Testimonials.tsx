...
export default function CompanyLink() {
  return (
    <section className="py-10 bg-[#ECECEC]">
      <div className="xl:w-9/12 lg:w-11/12 md:w-11/12 w-11/12 mx-auto">
        <div className="flex flex-col justify-center items-center space-y-4">
          <h2 className="text-[30px] font-[700] text-transparent bg-clip-text bg-[#000000]"><span className="text-[#C1202F]">Here is what our clients</span> have to say about us!</h2>
        </div>
        <div className=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1  gap-6 pt-10">
          <div className="border-2 p-4 space-y-2 bg-white shadow-sm">
