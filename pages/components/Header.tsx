      ...
      <header className="flex justify-between items-center  py-4 xl:w-9/12 lg:w-11/12 lg:px-0  md:px-8 px-4 mx-auto relative">
        ...
        <div className={showMe ? "lg:flex hidden lg:static  absolute top-20 left-0 lg:w-auto w-full  items-center   space-x-8 lg:p-0 p-4 md:opacity-100 opacity-0 transition-all duration-300" : "lg:flex   lg:static bg-[#D9D9D9] absolute top-20 left-0 lg:w-auto w-full  items-center   space-x-8 lg:p-0 p-4 transition-all duration-300 opacity-100 z-20"} >
          <div className="flex lg:flex-row flex-col items-center lg:space-x-6 lg:space-y-0 space-y-3">
            <a onClick={() => { setactive(active === 1 ? 0 : 1); toggle }} href="/" className={`  transition-all duration-300 ${active === 1 ? 'text-[#000000]' : 'text-[#000000] '}`}>Home </a>
            <a onClick={() => { setactive(active === 2 ? 0 : 2); toggle }} href="/#about" className={`  transition-all duration-300 ${active === 2 ? 'text-[#000000]' : 'text-[#000000] '}`}>About us </a>
            <a onClick={() => { setactive(active === 3 ? 0 : 3); toggle }} href="/#service" className={`  transition-all duration-300 ${active === 3 ? 'text-[#000000]' : 'text-[#000000] '}`}>Service </a>
